 ...
 */
final class Version20200315195001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cat AS SELECT id, user_id, name, color, filename, created_at, updated_at FROM cat');
        ...
        $this->addSql('INSERT INTO cat (id, user_id, name, color, filename, created_at, updated_at) SELECT id, user_id, name, color, filename, created_at, updated_at FROM __temp__cat');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cat AS SELECT id, user_id, name, color, filename, created_at, updated_at FROM cat');
        $this->addSql('DROP TABLE cat');
        $this->addSql('CREATE TABLE cat (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, race VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO cat (id, user_id, name, color, filename, created_at, updated_at) SELECT id, user_id, name, color, filename, created_at, updated_at FROM __temp__cat');
        $this->addSql('DROP TABLE __temp__cat');
        $this->addSql('CREATE INDEX IDX_9E5E43A8A76ED395 ON cat (user_id)');
    }
